...
//   const renderer = new WebGLRenderer({ div: document.getElementById('besttours'),antialias: true, alpha: true });
//   //const renderer1 = new WebGLRenderer({ div: document.getElementById('home'),antialias: true, alpha: true });
//   var objTo = document.getElementById('besttours');
//   renderer.setSize(objTo.offsetWidth, objTo.offsetHeight);
...
//   /*var objTo1= document.getElementById('home');
//   renderer1.setSize(objTo1.offsetWidth, objTo1.offsetHeight);
//   renderer1.toneMapping = ACESFilmicToneMapping;
//   renderer1.outputEncoding = sRGBEncoding;
//   renderer1.physicallyCorrectLights = true;
//   renderer1.shadowMap.enabled = true;
//   renderer1.shadowMap.type = PCFSoftShadowMap;
//   objTo1.appendChild(renderer1.domElement);*/
...
//         sheen: 1,
//         sheenRoughness: 0.75,
//         sheenColor: new Color("#08c2cc").convertSRGBToLinear(),
//         clearcoat: 0.5,
//       }),
//     );
...
//       var div1 = document.getElementById('besttours');
//       if(div1.clientWidth == 1920){
//         sphere.position.x = -20.5;
//         sphere.position.y = 3;
//         sphere.scale.set(1,1,1)
//         ring1.position.x = -20.5 + 1;
//         ring1.position.y = 3;
//         ring1.scale.set = (2,2,2);
//         ring2.position.x = -20.5;
//         ring2.scale.set(1,1,1)
//         ring3.position.x = -20.5;
//       }
...
//         scene.remove(sphere);
//         ringsScene.remove(ring1,ring2,ring3);
//         scene.clear();
//       }
//       else{
//         ringsScene.add(ring1,ring2,ring3);
//         scene.add(sphere);
...
//       //renderer1.render(ringsScene, ringsCamera);
...
//       .to(".besttours", { opacity: 0, scale: 0 }, "simultaneously");
//   })();
...
//     plane.scale.set(0.0012, 0.0012, 0.0012);
